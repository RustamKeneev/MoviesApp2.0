package com.example.moviesapp20.utils;
...
import com.example.moviesapp20.OnStartLoadingListener;
...
public class NetworkUtils {
    ...
    private static final String API_KEY = "YOUR_API_KEY  (https://www.themoviedb.org/)  ";
//    private static final String LANGUAGE_VALUE = "ru-RU";
    ...
    public static URL buildURLToVideos(int id,String language){
        Uri uri = Uri.parse(String.format(BASE_URL_VIDEOS,id)).buildUpon().appendQueryParameter(
                PARAMS_API_KEY,API_KEY).appendQueryParameter(PARAMS_LANGUAGE,language).build();
        try {
    ...
    public static URL buildURLToReviews(int id,String language){
        Uri uri = Uri.parse(String.format(BASE_URL_REVIEWS,id)).buildUpon().appendQueryParameter(
